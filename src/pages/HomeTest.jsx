...
const HomeTest = () => {
    ...
    const serviceValuesCollapseData = [
        ...
        },
        {
            ...
            children: <p>We handle your data and take your privacy very seriously and handle it carefully.</p>,
        },
        {
            key: '3',
            label: 'Prevent unstable prices',
            children: <p>We guarantee that what you see is what you get, and no hidden charges or cost whatsoever.</p>,
        },
    ];
                ...
                <div className="hero-section">
                    ...
                    <div className="hero-section-content">
                        ...
                        <div className="hero-sideimage-wrapper">
                            <img width={450} src="src/assets/sideimage-one.jpg" alt="" />
                        </div>
                    </div>
                </div>
                <section id="service-values">
                    <div className="service-values-centering-wrapper">
                        <div className="service-values-sideimage-wrapper">
                            <img src="/src/assets/sideimage-two.jpg" width={400} alt="" />
                        </div>
                        <div className="service-values-content-wrapper">
                            ...
                            <Text >We are always ready to help by providing the best services, we believe that a good place to live can make your life better.</Text>
                            <Collapse style={{ marginTop: "30px" }} items={serviceValuesCollapseData} defaultActiveKey={['1']} showArrow={false} />
                        </div>
                    </div>
                </section>
                    ...
                    <div className="service-values-centering-wrapper">
                        <div className="contact-us-content-wrapper">
                            ...
                            <Card style={{ marginTop: "40px" }}>
                                <Space direction='horizontal' align='baseline' style={{ alignItems: "center" }}>
                                    <div>
                                        <MessageOutlined style={{ color: "#1F3E72", fontSize: "24px " }} />
                                    </div>
                                    <Title level={4} style={{ margin: 0 }}>Message Us</Title>
                                </Space>
                                <div style={{ marginTop: "20px" }}>
                                    <Button size='large' type='primary'>Send a message</Button>
                                </div>
                            </Card>
                        </div>
                        <div className="service-values-sideimage-wrapper">
                            <img src="/src/assets/sideimage-three.avif" width={400} alt="" />
                        </div>
                    </div>
                </section>
                <section id="get-started">
                    <div className="get-started-centering-wrapper">
                        <div className="get-started-content-background-wrap">
                            ...
                            <Text>Subscribe and find super attractive price quotes from us, Find the perfect house for you.</Text>
