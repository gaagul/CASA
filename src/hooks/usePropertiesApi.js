...
const useGetPropertiesWithMatchingZipcodes = (userId, options) =>
  useQuery(
    [QUERY_KEYS.MATCH_BY_ZIPCODES],
    () => getPropertiesWithMatchingZipcodes(userId),
    {
      staleTime: STALE_TIME,
      ...options,
    }
...
const useGetPropertiesByUserId = userId =>
  useQuery(
    [QUERY_KEYS.PROPERTIES_OF_A_USER],
